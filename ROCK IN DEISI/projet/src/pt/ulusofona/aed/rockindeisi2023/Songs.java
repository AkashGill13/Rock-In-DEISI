...
//       CALCULO DE MILISEGUNDOS PARA MINUTOS : SEGUNDOS
        ...
        if (anoLancamento >= 1995 && anoLancamento < 2000) {
            ...
            if (anoLancamento>=2005){
                return  id + " | " + nome + " | " + anoLancamento + " | " + details.duracao + " | " + details.popularidade + " | " + numArt.get(0).nome;
            }
    ...
    public ArrayList<SongArtist> getSongs() {
        return Main.artistMap.get(id);
    }
